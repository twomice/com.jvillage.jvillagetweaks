...
class CRM_Contact_Form_Search_Custom_AdvancedPriceSetContributions extends CRM_Contact_Form_Search_Custom_Base implements CRM_Contact_Form_Search_Interface {
...
*/
  ...
  */
  ...
  function util_get_custom_field_sql() {
    ...
    $cf_table_name_sql  = "SELECT table_name FROM civicrm_custom_group cg WHERE extends = 'Participant'";
