...
class CRM_Contact_Form_Search_Custom_AdultChildRelationshipSearch extends CRM_Contact_Form_Search_Custom_Base implements CRM_Contact_Form_Search_Interface {
    ...
    function buildForm( &$form ) {
         ...
         */
        $this->setTitle('Find Adults and Children');
