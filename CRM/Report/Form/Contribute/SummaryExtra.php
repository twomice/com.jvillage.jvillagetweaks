 ...
 *
 */
class CRM_Report_Form_Contribute_SummaryExtra extends CRM_Report_Form {
 ...
 if( array_key_exists('civicrm_contribution_payment_instrument_id', $row)) {
	        switch( $row['civicrm_contribution_payment_instrument_id'] ){
	          case '1':
	             $rows[$rowNum]['civicrm_contribution_payment_instrument_id'] = ts('Credit Card');
	             break;
	          case '2':
	             $rows[$rowNum]['civicrm_contribution_payment_instrument_id'] = ts('Debit Card');
	             break;
	          case '3':
	             $rows[$rowNum]['civicrm_contribution_payment_instrument_id'] = ts('Cash');
	             break;
	          case '4':
	             $rows[$rowNum]['civicrm_contribution_payment_instrument_id'] = ts('Check');
	             break;
	          case '5':
	             $rows[$rowNum]['civicrm_contribution_payment_instrument_id'] = ts('EFT');
	             break;
