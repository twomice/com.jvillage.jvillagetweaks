...
class CRM_Financial_Form_Export extends CRM_Core_Form {
  ...
  public function buildQuickForm() {
    ...
    $optionTypes = array(
      ...
      'IIF' => ts('Export to IIF for QuickBooks Desktop - Journal Entries'), // JVILLAGE PATCH
      'CSV' => ts('Export to CSV'),
      // JVILLAGE ADD:
      'CSVACCOUNTEDGE' => ts('Export to CSV for Account Edge'),
      'IIFDEPOSIT' => ts('Export to IIF for QuickBooks Desktop - Deposits (uses account codes)'),
      'IIFJOURNALACCTNAME' => ts('Export to IIF for QuickBooks Desktop - Journal Entries (uses account names, contribution dates)'),
    );
